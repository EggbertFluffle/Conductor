...
/* package conductor-0.1.0.0 */
#ifndef VERSION_conductor
#define VERSION_conductor "0.1.0.0"
#endif /* VERSION_conductor */
#ifndef MIN_VERSION_conductor
#define MIN_VERSION_conductor(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_conductor */
...
#define CURRENT_COMPONENT_ID "conductor-0.1.0.0-inplace-conductor"
